<header class="mb-4">
    <nav class="navbar bg-neutral text-neutral-content">
        {{-- トップページへのリンク --}}
        <div class="flex-1">
            <h1><a class="btn btn-ghost normal-case text-xl" href="/">TaskTaskBoard</a></h1>
        </div>

        <div class="flex-none">
            <ul tabindex="0" class="menu hidden lg:block lg:menu-horizontal">
                <li><a class="link link-hover" href="{{ route('task.create') }}">新規タスクの投稿</a></li>
            </ul>
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 text-info">
                    {{-- メッセージ作成ページへのリンク --}}
                    <li><a class="link link-hover" href="{{ route('task.create') }}">新規タスク投稿</a></li>
                </ul>
            </div>
        </div>
    </nav>
